...
public class FontImage {
    ...
    public static BufferedImage createBufferedImage(Watermark watermark) {
        if (watermark == null) {
...
//        设置字体平滑
        ...
        g.drawString(DateUtil.format(new Date(), watermark.getDateFormat()), 0, y);// 画出字符串
